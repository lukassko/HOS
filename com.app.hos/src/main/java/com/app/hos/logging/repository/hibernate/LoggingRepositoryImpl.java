...
public class LoggingRepositoryImpl implements LoggingRepository {
	...
	@Transactional(value ="sqliteJpaTransactionManager",propagation = Propagation.REQUIRED)
	...
	@Transactional(value ="sqliteJpaTransactionManager", propagation = Propagation.SUPPORTS, readOnly = true)
	...
	@Transactional(transactionManager ="sqliteJpaTransactionManager",propagation = Propagation.SUPPORTS,readOnly = true)
